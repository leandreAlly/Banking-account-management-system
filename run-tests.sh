...
javac -d out src/com/leandre/exception/*.java src/com/leandre/validation/*.java src/com/leandre/transaction/*.java src/com/leandre/customer/*.java src/com/leandre/account/*.java src/com/leandre/cli/*.java src/com/leandre/Main.java
