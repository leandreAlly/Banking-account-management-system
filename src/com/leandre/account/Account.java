...
public abstract class Account implements Transactable {
    ...
    @Override
    public synchronized boolean processTransaction(double amount, String type) throws InsufficientFundsException, OverdraftExceededException {
    ...
    // OLD: public double deposit(double amount)
    // NEW: synchronized — ensures only one thread modifies balance at a time,
    //      preventing lost updates when concurrent deposits hit the same account
    ...
    // synchronized getter/setter — ensures threads read/write consistent balance values
